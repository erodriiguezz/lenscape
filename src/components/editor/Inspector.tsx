...
function InspectorTab({
  ...
  // TODO: Animation / AI Tools inspector tabs — not implemented yet.
  return (
    <button
      type="button"
      disabled
  ...
  return (
    <aside className="flex h-full w-studio-inspector shrink-0 flex-col border-l border-studio-border-subtle bg-studio-surface-container-high text-studio-on-surface">
      ...
      <nav className="flex border-b border-studio-border-subtle">
        <InspectorTab icon={SlidersHorizontal} label="Properties" active />
        <InspectorTab icon={AudioLines} label="Animation" />
        <InspectorTab icon={Sparkles} label="AI Tools" />
      </nav>
